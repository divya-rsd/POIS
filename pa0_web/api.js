...
const Backend = {
  ...
  pa13Primality: (n, k) => Backend.post('pa13/primality', { n, k }),
  ...
  pa17CcaEncrypt: (m) => Backend.post('pa17/encrypt', { m }),
  pa17CcaDecrypt: (c1, c2, sig) => Backend.post('pa17/decrypt_signcrypt', { c1, c2, sig }),
